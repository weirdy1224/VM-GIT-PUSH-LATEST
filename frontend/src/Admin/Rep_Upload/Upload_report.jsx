      ...
      <div className="container">
        {view === "options" && (
          <div className="options-container">
            <button className="option-button" onClick={() => setView("manual")}>
              Manual Entry
            </button>
            <button className="option-button" onClick={() => setView("upload")}>
              Upload PDF
            </button>
          </div>
        )}
        ...
        {view === "manual" && (
          <div className="manual-form">
              ...
              <div key={index} className="vulnerability-card">
                ...
                {vuln.remediation.map((remedy, i) => (
                  <input
                    ...
                    value={remedy}
                    onChange={(e) =>
                      handleInputChange(index, "remediation", e.target.value, i)
                    }
                    className="form-input"
            ...
            <button onClick={() => setView("options")} className="back-button">
              Back
            </button>
          </div>
        )}
